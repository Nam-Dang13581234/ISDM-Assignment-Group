...
* The system retrieves a customer’s details from the database and displays it to a RM. Then, the system also generates a script for RMs that would help them address end-customers effectively through outbound calls. 
