...
## Project Assumptions:
* Server and storage capacity is sufficient for all processes in the solution.
...
* As a customer, I want to be paired with a relationship manager with knowledge of my desired holiday, so that I can know more about the package.
* As a customer, I want to select my preferred language so that I can communicate more easily. 
* As a customer, I want to speak with someone understanding of my culture and social area, so that I can be more comfortable.
...
* As a customer, I want to be notified of the queue waiting times so that I can call back later. 
...
* As a RM, I want to receive customer details and script guidelines for products to recommend in targeted outbound calls, so that I am aware of what the customer may want and can improve my service.
